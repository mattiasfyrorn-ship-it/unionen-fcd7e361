    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center" onClick={() => setOpen(false)}>
          ...
          <div
            className="relative z-50 w-full max-w-sm mx-4 mb-4 sm:mb-0 rounded-2xl bg-card border border-border shadow-lg p-5 space-y-2 animate-in fade-in slide-in-from-bottom-4 duration-200"
